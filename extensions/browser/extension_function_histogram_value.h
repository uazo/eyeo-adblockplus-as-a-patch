...
enum HistogramValue {
  ...
  DELETED_ADBLOCKPRIVATE_SETUPDATECONSENT = 5002,
  DELETED_ADBLOCKPRIVATE_GETUPDATECONSENT = 5003,
  ADBLOCKPRIVATE_SETACCEPTABLEADSENABLED = 5004,
  ADBLOCKPRIVATE_ISACCEPTABLEADSENABLED = 5005,
  DELETED_ADBLOCKPRIVATE_ADDCUSTOMSUBSCRIPTION = 5006,
  DELETED_ADBLOCKPRIVATE_REMOVECUSTOMSUBSCRIPTION = 5007,
  DELETED_ADBLOCKPRIVATE_GETCUSTOMSUBSCRIPTIONS = 5008,
  ADBLOCKPRIVATE_GETBUILTINSUBSCRIPTIONS = 5009,
  DELETED_ADBLOCKPRIVATE_SELECTBUILTINSUBSCRIPTION = 5010,
  DELETED_ADBLOCKPRIVATE_UNSELECTBUILTINSUBSCRIPTION = 5011,
  DELETED_ADBLOCKPRIVATE_GETSELECTEDBUILTINSUBSCRIPTIONS = 5012,
  ...
  ADBLOCKPRIVATE_GETCUSTOMFILTERS = 5020,
  ADBLOCKPRIVATE_INSTALLSUBSCRIPTION = 5021,
  ADBLOCKPRIVATE_UNINSTALLSUBSCRIPTION = 5022,
  ADBLOCKPRIVATE_GETINSTALLEDSUBSCRIPTIONS = 5023,
