...
deps = {
  ...
  'src/tools/perf/eyeo_data': {
    # We currently only have WPR recorded for Android. If we add Desktop
    # recordings, remove `checkout_android` condition.
    'condition':
      'checkout_android and checkout_eyeo_wpr_archives',
    'url':
      Var('eyeo_distpartners_gitlab') + '/web-page-recordings.git@ec931d65bce04c273d4a4cb4950d2a7f7aa2f37f',
  },
  ...
  'src-internal': {
    'url': 'https://chrome-internal.googlesource.com/chrome/src-internal.git@d9ece1a7f2c6e17033a3ae1e66fbfe471410c682',
    'condition': 'checkout_src_internal',
  },
