...
declare global {
  export namespace chrome {
    export namespace adblockPrivate {
      ...
      export function getSelectedBuiltInSubscriptions(
        callback: (
          result: Subscription[],
        ) => void,
      ): void;

      export function selectBuiltInSubscription(
        url: string,
        feedback?: () => void,
      ): void;

      export function unselectBuiltInSubscription(
        url: string,
        feedback?: () => void,
      ): void;
      ...
      export function addCustomSubscription(
        url: string,
        feedback?: () => void,
      ): void;

      export function removeCustomSubscription(
        url: string,
        feedback?: () => void,
      ): void;
