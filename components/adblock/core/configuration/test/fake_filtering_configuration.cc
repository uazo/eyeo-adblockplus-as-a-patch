...
void FakeFilteringConfiguration::AddFilterList(GURL url) {
...
void FakeFilteringConfiguration::RemoveFilterList(GURL url) {
...
void FakeFilteringConfiguration::AddAllowedDomain(std::string domain) {
...
void FakeFilteringConfiguration::RemoveAllowedDomain(std::string domain) {
...
void FakeFilteringConfiguration::AddCustomFilter(std::string filter) {
...
void FakeFilteringConfiguration::RemoveCustomFilter(std::string filter) {
