...
class FilteringConfiguration {
 public:
  ...
  virtual void RemoveFilterList(GURL url) = 0;
  ...
  virtual void AddAllowedDomain(std::string domain) = 0;
  virtual void RemoveAllowedDomain(std::string domain) = 0;
  ...
  virtual void AddCustomFilter(std::string filter) = 0;
  virtual void RemoveCustomFilter(std::string filter) = 0;
